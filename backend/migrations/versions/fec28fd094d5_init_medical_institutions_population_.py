"""init: medical_institutions, population_mesh, population_mesh_age, diagnosis_logs

Revision ID: fec28fd094d5
Revises: 
Create Date: 2026-07-13 10:57:51.281044
...
def upgrade() -> None:
    ...
    op.create_index('idx_diagnosis_logs_geom', 'diagnosis_logs', ['geom'], unique=False, postgresql_using='gist')
    ...
    op.create_index('idx_medical_institutions_geom', 'medical_institutions', ['geom'], unique=False, postgresql_using='gist')
    ...
    op.create_index('idx_population_mesh_geom', 'population_mesh', ['geom'], unique=False, postgresql_using='gist')
...
def downgrade() -> None:
    ...
    op.drop_index('idx_population_mesh_geom', table_name='population_mesh', postgresql_using='gist')
    ...
    op.drop_index('idx_medical_institutions_geom', table_name='medical_institutions', postgresql_using='gist')
    op.drop_table('medical_institutions')
    op.drop_index(op.f('ix_diagnosis_logs_email'), table_name='diagnosis_logs')
    op.drop_index('idx_diagnosis_logs_geom', table_name='diagnosis_logs', postgresql_using='gist')
